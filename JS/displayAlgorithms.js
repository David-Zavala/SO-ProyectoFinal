...
fetch('Algs-Sched/RR.html').then(response => response.text()).then(html => {FIFOElement.innerHTML = html;});
fetch('Algs-Sched/SJF.html').then(response => response.text()).then(html => {FIFOElement.innerHTML = html;});
fetch('Algs-Sched/SRT.html').then(response => response.text()).then(html => {FIFOElement.innerHTML = html;});
fetch('Algs-Sched/HRRN.html').then(response => response.text()).then(html => {FIFOElement.innerHTML = html;});
fetch('Algs-Sched/MLFQ.html').then(response => response.text()).then(html => {FIFOElement.innerHTML = html;});
